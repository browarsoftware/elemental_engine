...
public class Calculator {
	...
	static void SetPrederterminedInfo(Player player)
	{
		ViewVector = new Vector(player.ViewTo[0] - player.ViewFrom[0], player.ViewTo[1] - player.ViewFrom[1], player.ViewTo[2] - player.ViewFrom[2]);			
		...
		P = new Plane(PlaneVector1, PlaneVector2, player.ViewTo);

		RotationVector = Calculator.getRotationVector(player.ViewFrom, player.ViewTo);
		W1 = ViewVector.CrossProduct(RotationVector);
		W2 = ViewVector.CrossProduct(W1);

		CalcFocusPos = Calculator.CalculatePositionP(player.ViewFrom, player.ViewTo, player.ViewTo[0], player.ViewTo[1], player.ViewTo[2]);
